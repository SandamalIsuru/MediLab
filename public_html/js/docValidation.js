...
function usernameVal(){
	...
	if(!username.match(/^[S][L][M][C][0-9]{4,4}$/)){
		producePrompt('<i class="fa fa-times"></i>',"commentUserNamePrompt","username","red");
		return false;
	}
...
function cityVal(){
	...
	if(!city.match(/^[a-zA-Z-,]+(\s{0,1}[a-zA-Z-, ])*$/)){
		producePrompt('<i class="fa fa-times"></i>',"commentAddressPrompt","city","red");
		return false;
	}
...
function reg_no_Val(){
	...
	if(reg_no.length == 0){
		producePrompt('<i class="fa fa-times"></i>',"commentRegPrompt","reg_no","red");
		return false;
	}
	producePrompt('<i class="fa fa-check"></i>',"commentRegPrompt","reg_no","green");
	return true;
}
...
function hospitalVal(){
	...
	if(hospital.length == 0){
		producePrompt('<i class="fa fa-times"></i>',"commentHospitalPrompt","hospital","red");
		return false;
	}
	producePrompt('<i class="fa fa-check"></i>',"commentHospitalPrompt","hospital","green");
	return true;
}
