...
<head>
    ...
    history.pushState(null, null, 'labassistant.php');
...
?>
    ...
    <div class="container_12">
        <div class="grid_6">
            ...
            <a id="signout" href="logout.php"> <u>(sign out)</u></a></h2>
            <script>
    ...
    <div class="container_12">
        <div class="main">
            ...
            <nav>
                ...
                <div class="L2"><a href="AddPatient.php"  id="A2">Add Patient</a></div>
                <div class="L3"><a href="searchpatient.php"  id="A3">Search Patient</a></div>
                <div class="L4"><a href="uploareports.php"  id="A4">Upload report Details</a></div>
            </nav>
