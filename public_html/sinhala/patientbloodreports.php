...
?>
    ...
    <div class="container_12">
        <div class="main">
            <div class="grid_6">
                <div class="blood"><a id="b" href="#" class="selected">Blood Reports</a></div>
            </div>
            <div class="grid_6">
            ...
            <div class="grid_10">
                ...
                <?php
                        ...
                        require 'classes/dbconnect.php';
                            ...
                            $result = $db->query("SELECT * FROM blood_report WHERE p_id='$user' ORDER BY dater DESC");
                            ...
                            if($result){
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<tr><td>$lab</td>
                                    <td><a href=\"tablebloodpdf.php?id=$userid&date=$date\" target=\"blank\">$date</a></td></tr>";
